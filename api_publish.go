...
/*
PublishApiService Publish a batch of messages
 ...
 * @param optional nil or *PublishApiPublishBulkPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []EmqxMgmtApiPublishPublishMessage) - 
@return []EmqxMgmtApiPublishPublishOk
*/

type PublishApiPublishBulkPostOpts struct {
    Body optional.Interface
}

func (a *PublishApiService) PublishBulkPost(ctx context.Context, localVarOptionals *PublishApiPublishBulkPostOpts) ([]EmqxMgmtApiPublishPublishOk, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []EmqxMgmtApiPublishPublishOk
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/publish/bulk"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []EmqxMgmtApiPublishPublishOk
		...
		if localVarHttpResponse.StatusCode == 202 {
			var v []EmqxMgmtApiPublishPublishError
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
PublishApiService Publish a message
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PublishApiPublishPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EmqxMgmtApiPublishPublishMessage) - 
@return EmqxMgmtApiPublishPublishOk
*/

type PublishApiPublishPostOpts struct {
    Body optional.Interface
}

func (a *PublishApiService) PublishPost(ctx context.Context, localVarOptionals *PublishApiPublishPostOpts) (EmqxMgmtApiPublishPublishOk, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
