...
type EmqxGatewayApiStomp struct {
	// Gateway Name
	Name string `json:"name,omitempty"`
	Frame *EmqxStompSchemaStompFrame `json:"frame,omitempty"`
	...
	Listeners []OneOfemqxGatewayApiStompListenersItems `json:"listeners,omitempty"`
}
