...
type EmqxGatewayApiClientsCoapClient struct {
	...
	ConnectedAt *OneOfemqxGatewayApiClientsCoapClientConnectedAt `json:"connected_at,omitempty"`
	// Client offline time, This field is only valid and returned when connected is false
	DisconnectedAt *OneOfemqxGatewayApiClientsCoapClientDisconnectedAt `json:"disconnected_at,omitempty"`
	...
	CreatedAt *OneOfemqxGatewayApiClientsCoapClientCreatedAt `json:"created_at,omitempty"`
