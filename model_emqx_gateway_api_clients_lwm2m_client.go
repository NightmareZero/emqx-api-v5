...
type EmqxGatewayApiClientsLwm2mClient struct {
	...
	ConnectedAt *OneOfemqxGatewayApiClientsLwm2mClientConnectedAt `json:"connected_at,omitempty"`
	// Client offline time, This field is only valid and returned when connected is false
	DisconnectedAt *OneOfemqxGatewayApiClientsLwm2mClientDisconnectedAt `json:"disconnected_at,omitempty"`
	...
	CreatedAt *OneOfemqxGatewayApiClientsLwm2mClientCreatedAt `json:"created_at,omitempty"`
