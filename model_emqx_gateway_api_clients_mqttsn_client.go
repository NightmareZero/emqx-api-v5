...
type EmqxGatewayApiClientsMqttsnClient struct {
	...
	ConnectedAt *OneOfemqxGatewayApiClientsMqttsnClientConnectedAt `json:"connected_at,omitempty"`
	// Client offline time, This field is only valid and returned when connected is false
	DisconnectedAt *OneOfemqxGatewayApiClientsMqttsnClientDisconnectedAt `json:"disconnected_at,omitempty"`
	...
	CreatedAt *OneOfemqxGatewayApiClientsMqttsnClientCreatedAt `json:"created_at,omitempty"`
