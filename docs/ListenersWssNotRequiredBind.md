...
**Bind** | **string** | IP address and port for the listening socket. | [optional] [default to 8084]
...
**MaxConnections** | [***OneOflistenersWssNotRequiredBindMaxConnections**](OneOflistenersWssNotRequiredBindMaxConnections.md) | The maximum number of concurrent connections allowed by the listener. | [optional] [default to infinity]
