...
**ConnectedAt** | [***OneOfemqxGatewayApiClientsExprotoClientConnectedAt**](OneOfemqxGatewayApiClientsExprotoClientConnectedAt.md) | Client connection time | [optional] [default to null]
**DisconnectedAt** | [***OneOfemqxGatewayApiClientsExprotoClientDisconnectedAt**](OneOfemqxGatewayApiClientsExprotoClientDisconnectedAt.md) | Client offline time, This field is only valid and returned when connected is false | [optional] [default to null]
...
**CreatedAt** | [***OneOfemqxGatewayApiClientsExprotoClientCreatedAt**](OneOfemqxGatewayApiClientsExprotoClientCreatedAt.md) | Session creation time | [optional] [default to null]
