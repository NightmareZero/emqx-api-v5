...
**Bind** | **string** | IP address and port for the listening socket. | [default to 8083]
**Acceptors** | **int32** | The size of the listener&#x27;s receiving pool. | [optional] [default to 16]
**MaxConnections** | [***OneOflistenersWsRequiredBindWithNameMaxConnections**](OneOflistenersWsRequiredBindWithNameMaxConnections.md) | The maximum number of concurrent connections allowed by the listener. | [optional] [default to infinity]
