...
**Bind** | **string** | IP address and port for the listening socket. | [optional] [default to 8883]
...
**MaxConnections** | [***OneOflistenersSslNotRequiredBindMaxConnections**](OneOflistenersSslNotRequiredBindMaxConnections.md) | The maximum number of concurrent connections allowed by the listener. | [optional] [default to infinity]
