...
**MaxConnections** | [***OneOfemqxGatewayApiDtlsListenerMaxConnections**](OneOfemqxGatewayApiDtlsListenerMaxConnections.md) | Maximum number of concurrent connections. | [optional] [default to 1024]
