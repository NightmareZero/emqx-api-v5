...
**MaxConnections** | [***OneOflistenersWssRequiredBindMaxConnections**](OneOflistenersWssRequiredBindMaxConnections.md) | The maximum number of concurrent connections allowed by the listener. | [optional] [default to infinity]
