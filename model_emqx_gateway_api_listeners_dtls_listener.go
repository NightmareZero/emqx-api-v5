...
type EmqxGatewayApiListenersDtlsListener struct {
	// Listener ID
	...
	MaxConnections *OneOfemqxGatewayApiListenersDtlsListenerMaxConnections `json:"max_connections,omitempty"`
	...
	DtlsOptions *GatewayDtlsOpts `json:"dtls_options,omitempty"`
