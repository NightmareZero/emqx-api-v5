...
type ExhookDetailServerInfo struct {
	Metrics *ExhookMetrics `json:"metrics,omitempty"`
	// Metrics information of this server in all nodes
	NodeMetrics []ExhookNodeMetrics `json:"node_metrics,omitempty"`
	// status of this server in all nodes
	NodeStatus []ExhookNodeStatus `json:"node_status,omitempty"`
	Hooks []ExhookHookInfo `json:"hooks,omitempty"`
	...
	AutoReconnect *OneOfexhookDetailServerInfoAutoReconnect `json:"auto_reconnect,omitempty"`
