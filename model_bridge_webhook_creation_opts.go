...
type BridgeWebhookCreationOpts struct {
	...
	AutoRestartInterval *OneOfbridgeWebhookCreationOptsAutoRestartInterval `json:"auto_restart_interval,omitempty"`
	...
	RequestTtl *OneOfbridgeWebhookCreationOptsRequestTtl `json:"request_ttl,omitempty"`
