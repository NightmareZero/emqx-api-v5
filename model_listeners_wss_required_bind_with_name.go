...
type ListenersWssRequiredBindWithName struct {
	// Listener type
	...
	MaxConnections *OneOflistenersWssRequiredBindWithNameMaxConnections `json:"max_connections,omitempty"`
	...
	SslOptions *BrokerListenerWssOpts `json:"ssl_options,omitempty"`
	Websocket *BrokerWsOpts `json:"websocket,omitempty"`
}
