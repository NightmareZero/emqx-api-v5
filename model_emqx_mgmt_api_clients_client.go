...
type EmqxMgmtApiClientsClient struct {
	...
	ConnectedAt *OneOfemqxMgmtApiClientsClientConnectedAt `json:"connected_at,omitempty"`
	// Session creation time, rfc3339 or timestamp(millisecond)
	CreatedAt *OneOfemqxMgmtApiClientsClientCreatedAt `json:"created_at,omitempty"`
	// Client offline time. It's Only valid and returned when connected is false, rfc3339 or timestamp(millisecond)
	DisconnectedAt *OneOfemqxMgmtApiClientsClientDisconnectedAt `json:"disconnected_at,omitempty"`
